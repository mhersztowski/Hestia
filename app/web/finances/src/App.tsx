...
export function App() {
  ...
  const categoryNames = useMemo(() => new Map(categories.map((k) => [k.id, k.name])), [categories]);
                      ...
                      >
                        <Box>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {ACCOUNT_KIND_NAMES[k.kind]}
                          </Typography>
                        </Box>
                        <Typography variant="body2" fontFamily="monospace">
                          {formatAmount(k.balance)}
                        </Typography>
                      </Stack>
                    ))}
                  ...
                  {transactions.map((t) => (
                    ...
                    >
                      ...
                      {t.categoryId && (
                        <Chip
                          size="small"
                          label={categoryNames.get(t.categoryId) ?? t.categoryId}
                        />
                      )}
                      <Typography
                        variant="body2"
  ...
  return (
    <Card sx={{ flex: 1 }}>
      <CardContent>
        ...
        <Typography variant="h5" color={color} fontFamily="monospace">
          {formatAmount(amount)}
        </Typography>
        {caption && (
          <Typography variant="caption" color="text.secondary">
...
function CategoryBars({
  ...
  categories: Array<{ categoryId: string; name: string; total: number; color?: string }>;
}) {
