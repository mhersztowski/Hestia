 ...
 *
 * The root is the whole of the user's space rather than `cad/`: this panel is
 * for looking at what is on the drive, including what another application put
 * there, and a drive that shows one directory is a file picker, not a drive.
 */
