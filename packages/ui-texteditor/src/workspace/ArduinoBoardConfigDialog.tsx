...
export function ArduinoBoardConfigDialog({
  open,
  context,
  onClose,
  onSave,
}: ArduinoBoardConfigDialogProps) {
  const currentFqbn =
    context.fqbn ??
      ...
      <DialogContent>
        ...
        {!optionSet && fqbn && (
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            No configurable options for this board type. Edit the FQBN directly in project.json if
            needed.
          </Typography>
        )}
