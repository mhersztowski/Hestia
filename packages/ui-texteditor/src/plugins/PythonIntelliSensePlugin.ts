...
const PYTHON_BUILTINS: PySymbol[] = [
  // Functions
  {
    ...
    doc: 'Print objects to the text stream.',
  },
  {
    name: 'len',
    kind: CK.Function,
    detail: 'len(s)',
    doc: 'Return the number of items in an object.',
  },
  {
    name: 'range',
    kind: CK.Function,
    detail: 'range(stop) / range(start, stop[, step])',
    doc: 'Return a range object.',
  },
  ...
  { name: 'bool', kind: CK.Class, detail: 'bool(x=False)', doc: 'Create a boolean value.' },
  {
    ...
    kind: CK.Class,
    detail: 'bytes(source)',
    doc: 'Create an immutable bytes object.',
  },
  {
    name: 'bytearray',
    kind: CK.Class,
    detail: 'bytearray(source)',
    doc: 'Create a mutable bytearray.',
  },
  { name: 'type', kind: CK.Function, detail: 'type(object)', doc: 'Return the type of an object.' },
  {
    name: 'isinstance',
    kind: CK.Function,
    detail: 'isinstance(object, classinfo)',
    doc: 'Return True if object is an instance of classinfo.',
  },
  {
    name: 'issubclass',
    kind: CK.Function,
    detail: 'issubclass(class, classinfo)',
    doc: 'Return True if class is a subclass of classinfo.',
  },
  {
    name: 'hasattr',
    kind: CK.Function,
    detail: 'hasattr(object, name)',
    doc: 'Return True if object has the named attribute.',
  },
  {
    name: 'getattr',
    kind: CK.Function,
    detail: 'getattr(object, name[, default])',
    doc: 'Get a named attribute from an object.',
  },
  {
    name: 'setattr',
    kind: CK.Function,
    detail: 'setattr(object, name, value)',
    doc: 'Set a named attribute on an object.',
  },
  {
    name: 'delattr',
    kind: CK.Function,
    detail: 'delattr(object, name)',
    doc: 'Delete the named attribute from the object.',
  },
  {
    name: 'open',
    kind: CK.Function,
    detail: 'open(file, mode="r", encoding=None)',
  ...
  },
  {
    name: 'max',
    kind: CK.Function,
    detail: 'max(iterable) / max(*args)',
    doc: 'Return the largest item.',
  },
  {
    name: 'min',
    kind: CK.Function,
    detail: 'min(iterable) / min(*args)',
  ...
  },
  {
    ...
    doc: 'Make an iterator that aggregates elements.',
  },
  {
    name: 'map',
    kind: CK.Function,
    detail: 'map(function, iterable)',
    doc: 'Return an iterator that applies function to every item.',
  },
  {
    name: 'filter',
    kind: CK.Function,
    detail: 'filter(function, iterable)',
    doc: 'Return an iterator yielding items for which function returns True.',
  },
  {
    name: 'any',
    kind: CK.Function,
  ...
  },
  {
    ...
    kind: CK.Function,
    detail: 'hex(x)',
    doc: 'Convert an integer to a lowercase hexadecimal string.',
  },
  {
    name: 'oct',
    kind: CK.Function,
  ...
  },
  {
    ...
    kind: CK.Function,
    detail: 'ord(c)',
    doc: 'Return the Unicode code point for the given character.',
  },
  {
    name: 'chr',
    kind: CK.Function,
    detail: 'chr(i)',
    doc: 'Return the string representing a character whose Unicode code point is i.',
  },
  {
    name: 'repr',
    kind: CK.Function,
    detail: 'repr(object)',
    doc: 'Return a string representation of the object.',
  },
  {
    name: 'vars',
    kind: CK.Function,
    detail: 'vars([object])',
    doc: 'Return the __dict__ attribute for the object.',
  },
  {
    name: 'dir',
    kind: CK.Function,
    detail: 'dir([object])',
    doc: 'Return a list of names in the current local scope or attributes of object.',
  },
  {
    name: 'callable',
    kind: CK.Function,
    detail: 'callable(object)',
    doc: 'Return True if the object appears callable.',
  },
  {
    name: 'super',
    kind: CK.Function,
    detail: 'super([type[, object]])',
    doc: 'Return a proxy object delegating method calls to a parent class.',
  },
  { name: 'object', kind: CK.Class, detail: 'object()', doc: 'Base class for all classes.' },
  {
    name: 'property',
    kind: CK.Function,
    detail: 'property(fget=None, fset=None, fdel=None, doc=None)',
    doc: 'Return a property attribute.',
  },
  {
    name: 'staticmethod',
    kind: CK.Function,
    detail: 'staticmethod(function)',
    doc: 'Transform a method into a static method.',
  },
  {
    name: 'classmethod',
    kind: CK.Function,
    detail: 'classmethod(function)',
    doc: 'Transform a method into a class method.',
  },
  {
    name: 'round',
    kind: CK.Function,
    detail: 'round(number[, ndigits])',
    doc: 'Round a number to a given precision.',
  },
  {
    name: 'pow',
    kind: CK.Function,
    detail: 'pow(base, exp[, mod])',
    doc: 'Return base to the power exp.',
  },
  {
    name: 'divmod',
    kind: CK.Function,
    detail: 'divmod(a, b)',
    doc: 'Return a pair (a // b, a % b).',
  },
  {
    name: 'globals',
    kind: CK.Function,
    detail: 'globals()',
    doc: 'Return a dictionary of the global symbol table.',
  },
  { name: 'locals', kind: CK.Function, detail: 'locals()', doc: 'Return the local symbol table.' },
  {
    ...
    kind: CK.Function,
    detail: 'exec(object)',
    doc: 'Execute dynamically created Python code.',
  },
  {
    name: 'eval',
    kind: CK.Function,
  ...
  },
  {
    name: 'compile',
    kind: CK.Function,
    detail: 'compile(source, filename, mode)',
    doc: 'Compile source into a code object.',
  },
  {
    name: 'format',
    kind: CK.Function,
    detail: 'format(value[, format_spec])',
    doc: 'Convert a value to a formatted representation.',
  },
  {
    name: 'memoryview',
    kind: CK.Class,
    detail: 'memoryview(obj)',
    doc: 'Create a memory view object.',
  },
  // Exceptions
  {
    name: 'Exception',
    kind: CK.Class,
    detail: 'Exception',
    doc: 'Base class for non-system exceptions.',
  },
  {
    name: 'ValueError',
    kind: CK.Class,
    detail: 'ValueError',
    doc: 'Raised when an operation receives an argument with the right type but wrong value.',
  },
  {
    name: 'TypeError',
    kind: CK.Class,
    detail: 'TypeError',
    doc: 'Raised when an operation is applied to an object of inappropriate type.',
  },
  {
    name: 'KeyError',
    kind: CK.Class,
    detail: 'KeyError',
    doc: 'Raised when a mapping key is not found.',
  },
  {
    name: 'IndexError',
    kind: CK.Class,
    detail: 'IndexError',
    doc: 'Raised when a sequence index is out of range.',
  },
  {
    name: 'AttributeError',
    kind: CK.Class,
    detail: 'AttributeError',
    doc: 'Raised when attribute reference or assignment fails.',
  },
  {
    name: 'ImportError',
    kind: CK.Class,
    detail: 'ImportError',
    doc: 'Raised when an import statement fails.',
  },
  {
    name: 'OSError',
    kind: CK.Class,
    detail: 'OSError',
    doc: 'Raised when a system-related operation fails.',
  },
  { name: 'IOError', kind: CK.Class, detail: 'IOError', doc: 'Alias for OSError.' },
  {
    ...
    kind: CK.Class,
    detail: 'RuntimeError',
    doc: 'Raised when an error does not fall in any other category.',
  },
  {
    name: 'StopIteration',
    kind: CK.Class,
    detail: 'StopIteration',
    doc: 'Raised by an iterator when no more items are produced.',
  },
  {
    name: 'StopAsyncIteration',
    kind: CK.Class,
    detail: 'StopAsyncIteration',
    doc: 'Raised by an async iterator when no more items are produced.',
  },
  {
    name: 'NotImplementedError',
    kind: CK.Class,
    detail: 'NotImplementedError',
    doc: 'Raised when an abstract method is not implemented.',
  },
  {
    name: 'MemoryError',
    kind: CK.Class,
    detail: 'MemoryError',
    doc: 'Raised when an operation runs out of memory.',
  },
  {
    name: 'OverflowError',
    kind: CK.Class,
    detail: 'OverflowError',
    doc: 'Raised when an arithmetic operation exceeds limits.',
  },
  {
    name: 'ZeroDivisionError',
    kind: CK.Class,
    detail: 'ZeroDivisionError',
    doc: 'Raised when division by zero is attempted.',
  },
  {
    name: 'FileNotFoundError',
    kind: CK.Class,
    detail: 'FileNotFoundError',
    doc: 'Raised when a file is not found.',
  },
  {
    name: 'PermissionError',
    kind: CK.Class,
    detail: 'PermissionError',
    doc: 'Raised when an operation is not permitted.',
  },
  {
    name: 'TimeoutError',
    kind: CK.Class,
    detail: 'TimeoutError',
    doc: 'Raised when a system function times out.',
  },
  {
    name: 'KeyboardInterrupt',
    kind: CK.Class,
    detail: 'KeyboardInterrupt',
    doc: 'Raised when the user presses Ctrl+C.',
  },
  { name: 'SystemExit', kind: CK.Class, detail: 'SystemExit', doc: 'Raised by sys.exit().' },
  {
    ...
    doc: 'Raised when an assert statement fails.',
  },
  {
    name: 'NameError',
    kind: CK.Class,
    detail: 'NameError',
    doc: 'Raised when a name is not found.',
  },
  {
    name: 'SyntaxError',
    kind: CK.Class,
    detail: 'SyntaxError',
    doc: 'Raised when a syntax error is encountered.',
  },
  {
    name: 'UnicodeError',
    kind: CK.Class,
    detail: 'UnicodeError',
    doc: 'Raised when a Unicode-related error occurs.',
  },
  {
    name: 'UnicodeDecodeError',
    kind: CK.Class,
    detail: 'UnicodeDecodeError',
    doc: 'Raised when decoding with a codec fails.',
  },
  {
    name: 'UnicodeEncodeError',
    kind: CK.Class,
    detail: 'UnicodeEncodeError',
    doc: 'Raised when encoding with a codec fails.',
  },
  // Constants
  ...
  { name: 'None', kind: CK.Constant, detail: 'None', doc: 'The None object.' },
  {
    ...
    doc: 'Should be returned when binary operations are not implemented.',
  },
...
const MODULE_STUBS: ModuleMap = {
  machine: [
    {
      name: 'Pin',
      kind: CK.Class,
      detail: 'Pin(id, mode=-1, pull=-1, value=None, alt=-1)',
      doc: 'Access and control I/O pins. `mode`: `Pin.IN`, `Pin.OUT`, `Pin.OPEN_DRAIN`. `pull`: `Pin.PULL_UP`, `Pin.PULL_DOWN`, `Pin.PULL_HOLD`.',
    },
    {
      name: 'ADC',
      kind: CK.Class,
      detail: 'ADC(id)',
      doc: 'Provides an interface to analog-to-digital converters.',
    },
    {
      name: 'PWM',
      kind: CK.Class,
      detail: 'PWM(pin, freq=None, duty_u16=None, duty_ns=None)',
      doc: 'Provides Pulse Width Modulation output.',
    },
    {
      name: 'UART',
      kind: CK.Class,
      detail: 'UART(id, baudrate=9600, bits=8, parity=None, stop=1, tx=None, rx=None)',
      doc: 'Full duplex serial protocol.',
    },
    {
      name: 'SPI',
      kind: CK.Class,
      detail:
        'SPI(id, baudrate=1000000, polarity=0, phase=0, bits=8, firstbit=SPI.MSB, sck=None, mosi=None, miso=None)',
      doc: 'Serial Peripheral Interface bus.',
    },
    {
      name: 'I2C',
      kind: CK.Class,
      detail: 'I2C(id, scl=None, sda=None, freq=400000)',
      doc: 'Two-wire serial protocol.',
    },
    {
      name: 'SoftI2C',
      kind: CK.Class,
      detail: 'SoftI2C(scl, sda, freq=400000, timeout=50000)',
      doc: 'Software-based I2C implementation.',
    },
    {
      name: 'SoftSPI',
      kind: CK.Class,
      detail:
        'SoftSPI(baudrate=500000, polarity=0, phase=0, bits=8, firstbit=SPI.MSB, sck=None, mosi=None, miso=None)',
      doc: 'Software-based SPI implementation.',
    },
    {
      name: 'Timer',
      kind: CK.Class,
      detail: 'Timer(id=-1, mode=Timer.PERIODIC, period=-1, callback=None)',
      doc: 'Hardware timer.',
    },
    { name: 'RTC', kind: CK.Class, detail: 'RTC()', doc: 'Real-time clock.' },
    {
      name: 'WDT',
      kind: CK.Class,
      detail: 'WDT(id=0, timeout=5000)',
      doc: 'Watchdog timer. Resets the system if not fed.',
    },
    {
      name: 'reset',
      kind: CK.Function,
      detail: 'reset()',
      doc: 'Performs a hard reset of the device.',
    },
    {
      name: 'soft_reset',
      kind: CK.Function,
      detail: 'soft_reset()',
      doc: 'Performs a soft reset of the interpreter.',
    },
    {
      name: 'reset_cause',
      kind: CK.Function,
      detail: 'reset_cause() -> int',
      doc: 'Returns the reset cause.',
    },
    {
      name: 'freq',
      kind: CK.Function,
      detail: 'freq(hz?) -> int',
      doc: 'Returns the CPU running frequency, or sets it if hz is given.',
    },
    {
      name: 'enable_irq',
      kind: CK.Function,
      detail: 'enable_irq(state)',
      doc: 'Re-enable interrupt requests. Returns the previous IRQ state.',
    },
    {
      name: 'disable_irq',
      kind: CK.Function,
      detail: 'disable_irq() -> state',
      doc: 'Disables interrupt requests. Returns previous IRQ state.',
    },
    {
      name: 'idle',
      kind: CK.Function,
      detail: 'idle()',
      doc: 'Gates the clock to the CPU, useful for reducing power consumption.',
    },
    {
      name: 'sleep',
      kind: CK.Function,
      detail: 'sleep()',
      doc: 'Stops execution to reduce power consumption (deep sleep until interrupt).',
    },
    {
      name: 'deepsleep',
      kind: CK.Function,
      detail: 'deepsleep(time_ms?)',
      doc: 'Stops execution in an attempt to enter a low power state. Device wakes after time_ms ms.',
    },
    {
      name: 'lightsleep',
      kind: CK.Function,
      detail: 'lightsleep(time_ms?)',
      doc: 'Light sleep. Execution resumes from the point where it was stopped.',
    },
    {
      name: 'unique_id',
      kind: CK.Function,
      detail: 'unique_id() -> bytes',
      doc: 'Returns a byte string with a unique identifier of a board/SoC.',
    },
    {
      name: 'time_pulse_us',
      kind: CK.Function,
      detail: 'time_pulse_us(pin, pulse_level, timeout_us=1000000)',
      doc: 'Time a pulse on the given pin.',
    },
    {
      name: 'bitstream',
      kind: CK.Function,
      detail: 'bitstream(pin, encoding, timing, data)',
      doc: 'Transmits data by bit-banging the specified pin.',
    },
    {
      name: 'mem8',
      kind: CK.Variable,
      detail: 'mem8: IndexedMemory',
      doc: 'Read/write 8-bit memory.',
    },
    {
      name: 'mem16',
      kind: CK.Variable,
      detail: 'mem16: IndexedMemory',
      doc: 'Read/write 16-bit memory.',
    },
    {
      name: 'mem32',
      kind: CK.Variable,
      detail: 'mem32: IndexedMemory',
      doc: 'Read/write 32-bit memory.',
    },
    ...
    { name: 'OUT', kind: CK.Constant, detail: 'Pin.OUT = 3', doc: 'Pin mode: output.' },
    {
      name: 'OPEN_DRAIN',
      kind: CK.Constant,
      detail: 'Pin.OPEN_DRAIN = 7',
      doc: 'Pin mode: open drain.',
    },
    {
      name: 'PULL_UP',
      kind: CK.Constant,
      detail: 'Pin.PULL_UP = 1',
      doc: 'Enable pull-up resistor.',
    },
    {
      name: 'PULL_DOWN',
      kind: CK.Constant,
      detail: 'Pin.PULL_DOWN = 2',
      doc: 'Enable pull-down resistor.',
    },
    ...
    { name: 'PWROFF', kind: CK.Constant, detail: 'machine.PWROFF', doc: 'Power off reset cause.' },
    {
      name: 'HARD_RESET',
      kind: CK.Constant,
      detail: 'machine.HARD_RESET',
      doc: 'Hard reset cause.',
    },
    {
      name: 'WDT_RESET',
      kind: CK.Constant,
      detail: 'machine.WDT_RESET',
      doc: 'Watchdog reset cause.',
    },
    {
      name: 'DEEPSLEEP_RESET',
      kind: CK.Constant,
      detail: 'machine.DEEPSLEEP_RESET',
      doc: 'Deep sleep reset cause.',
    },
    {
      name: 'SOFT_RESET',
      kind: CK.Constant,
      detail: 'machine.SOFT_RESET',
      doc: 'Soft reset cause.',
    },
  ],
  ...
  network: [
    {
      name: 'WLAN',
      kind: CK.Class,
      detail: 'WLAN(interface_id)',
      doc: 'Provides a driver for WiFi network processors.',
    },
    {
      name: 'STA_IF',
      kind: CK.Constant,
      detail: 'network.STA_IF = 0',
      doc: 'Station (client) interface — connects to an access point.',
    },
    {
      name: 'AP_IF',
      kind: CK.Constant,
      detail: 'network.AP_IF = 1',
      doc: 'Access point interface — accepts connections from clients.',
    },
  ],
  ...
  time: [
    ...
    },
    {
      ...
      kind: CK.Function,
      detail: 'sleep_ms(ms)',
      doc: 'Delay for given number of milliseconds.',
    },
    {
      name: 'sleep_us',
      kind: CK.Function,
      detail: 'sleep_us(us)',
      doc: 'Delay for given number of microseconds.',
    },
    {
      name: 'ticks_ms',
      kind: CK.Function,
      detail: 'ticks_ms() -> int',
      doc: 'Returns an increasing millisecond counter (wraps around).',
    },
    {
      name: 'ticks_us',
      kind: CK.Function,
      detail: 'ticks_us() -> int',
      doc: 'Returns an increasing microsecond counter (wraps around).',
    },
    {
      name: 'ticks_cpu',
      kind: CK.Function,
      detail: 'ticks_cpu() -> int',
      doc: 'Returns an increasing CPU cycle counter (wraps around).',
    },
    {
      name: 'ticks_add',
      kind: CK.Function,
      detail: 'ticks_add(ticks, delta) -> int',
      doc: 'Offset ticks value by a given number.',
    },
    {
      name: 'ticks_diff',
      kind: CK.Function,
      detail: 'ticks_diff(ticks1, ticks2) -> int',
      doc: 'Measure ticks difference. Returns signed value.',
    },
    {
      name: 'time',
      kind: CK.Function,
      detail: 'time() -> int',
      doc: 'Returns the number of seconds since the Epoch (2000-01-01).',
    },
    {
      name: 'time_ns',
      kind: CK.Function,
      detail: 'time_ns() -> int',
      doc: 'Returns the number of nanoseconds since the Epoch.',
    },
    {
      name: 'gmtime',
      kind: CK.Function,
      detail: 'gmtime([secs]) -> tuple',
      doc: 'Convert a time expressed in seconds to a tuple (year, month, mday, hour, min, sec, weekday, yearday).',
    },
    {
      name: 'localtime',
      kind: CK.Function,
      detail: 'localtime([secs]) -> tuple',
      doc: 'Like gmtime() but converts to local time.',
    },
    {
      name: 'mktime',
      kind: CK.Function,
      detail: 'mktime(t) -> int',
      doc: 'Inverse of localtime(). Returns seconds since the Epoch.',
    },
  ],
  ...
  json: [
    {
      name: 'loads',
      kind: CK.Function,
      detail: 'loads(str) -> object',
      doc: 'Parse the JSON str and return a Python object.',
    },
    {
      name: 'dumps',
      kind: CK.Function,
      detail: 'dumps(obj, separators=None) -> str',
      doc: 'Return the JSON representation of obj as a str.',
    },
    {
      name: 'load',
      kind: CK.Function,
      detail: 'load(stream) -> object',
      doc: 'Parse JSON from a file-like object.',
    },
    {
      name: 'dump',
      kind: CK.Function,
      detail: 'dump(obj, stream)',
      doc: 'Write JSON representation of obj to stream.',
    },
  ],
  ...
  os: [
    {
      name: 'listdir',
      kind: CK.Function,
      detail: 'listdir([dir="/"]) -> list',
      doc: 'List the contents of the directory.',
    },
    ...
    { name: 'remove', kind: CK.Function, detail: 'remove(path)', doc: 'Remove a file.' },
    {
      name: 'rename',
      kind: CK.Function,
      detail: 'rename(old_path, new_path)',
      doc: 'Rename a file.',
    },
    {
      name: 'getcwd',
    ...
    },
    {
      name: 'stat',
      kind: CK.Function,
      detail: 'stat(path) -> tuple',
      doc: 'Get the status of a file or directory.',
    },
    {
      name: 'statvfs',
      kind: CK.Function,
      detail: 'statvfs(path) -> tuple',
      doc: 'Get the status of a filesystem.',
    },
    {
      name: 'ilistdir',
      kind: CK.Function,
      detail: 'ilistdir([dir]) -> iterator',
      doc: 'List directory, returning an iterator of tuples (name, type, inode, size).',
    },
    { name: 'sync', kind: CK.Function, detail: 'sync()', doc: 'Sync all filesystems.' },
    {
      name: 'urandom',
      kind: CK.Function,
      detail: 'urandom(n) -> bytes',
      doc: 'Return n random bytes.',
    },
    {
      name: 'dupterm',
      kind: CK.Function,
      detail: 'dupterm(stream_object, index=0)',
      doc: 'Duplicate or switch the MicroPython terminal.',
    },
    {
      name: 'mount',
      kind: CK.Function,
      detail: 'mount(fsobj, mount_point, readonly=False)',
    ...
    { name: 'O_WRONLY', kind: CK.Constant, detail: 'os.O_WRONLY', doc: 'Open for writing only.' },
    {
      ...
      kind: CK.Constant,
      detail: 'os.O_RDWR',
      doc: 'Open for reading and writing.',
    },
    {
      name: 'O_CREAT',
      kind: CK.Constant,
    ...
    },
    {
      ...
      kind: CK.Constant,
      detail: 'os.O_TRUNC',
      doc: 'Truncate file to zero length.',
    },
  ...
  sys: [
    {
      name: 'exit',
      kind: CK.Function,
      detail: 'exit([retval=0])',
      doc: 'Raise SystemExit with the given retval.',
    },
    {
      name: 'print_exception',
      kind: CK.Function,
      detail: 'print_exception(exc, file=sys.stdout)',
      doc: 'Print exception with a traceback.',
    },
    {
      name: 'path',
      kind: CK.Variable,
      detail: 'sys.path: list[str]',
      doc: 'List of directories searched for modules.',
    },
    {
      name: 'modules',
      kind: CK.Variable,
      detail: 'sys.modules: dict',
      doc: 'Dictionary of loaded modules.',
    },
    {
      name: 'version',
      kind: CK.Variable,
      detail: 'sys.version: str',
      doc: 'Python version as a string.',
    },
    {
      name: 'version_info',
      kind: CK.Variable,
      detail: 'sys.version_info: tuple',
      doc: 'Python version as a tuple.',
    },
    {
      name: 'implementation',
      kind: CK.Variable,
      detail: 'sys.implementation',
      doc: 'Implementation information.',
    },
    {
      name: 'platform',
      kind: CK.Variable,
      detail: 'sys.platform: str',
      doc: 'Platform identifier.',
    },
    {
      name: 'byteorder',
      kind: CK.Variable,
      detail: 'sys.byteorder: str',
      doc: '"little" or "big".',
    },
    {
      name: 'maxsize',
      ...
      doc: 'Maximum value a native integer type can hold.',
    },
  ...
  gc: [
    ...
    },
    {
      ...
      kind: CK.Function,
      detail: 'gc.collect()',
      doc: 'Run a garbage collection.',
    },
    {
      name: 'mem_free',
      kind: CK.Function,
      detail: 'gc.mem_free() -> int',
      doc: 'Return the number of bytes of heap RAM available.',
    },
    {
      name: 'mem_alloc',
      kind: CK.Function,
      detail: 'gc.mem_alloc() -> int',
      doc: 'Return the number of bytes of heap RAM allocated.',
    },
    {
      name: 'threshold',
      kind: CK.Function,
      detail: 'gc.threshold([amount])',
      doc: 'Set or return the allocation threshold.',
    },
  ],
  ...
  micropython: [
    {
      name: 'const',
      kind: CK.Function,
      detail: 'micropython.const(expr)',
      doc: 'Declare a constant. Allows the compiler to optimize it. Use: CONST = micropython.const(123).',
    },
    {
      name: 'opt_level',
      kind: CK.Function,
      detail: 'micropython.opt_level([level])',
      doc: 'Get or set the compiler optimisation level for the current file.',
    },
    {
      name: 'mem_info',
      kind: CK.Function,
      detail: 'micropython.mem_info([verbose])',
      doc: 'Print information about currently used memory.',
    },
    {
      name: 'qstr_info',
      kind: CK.Function,
      detail: 'micropython.qstr_info([verbose])',
      doc: 'Print information about currently interned strings.',
    },
    {
      name: 'stack_use',
      kind: CK.Function,
      detail: 'micropython.stack_use() -> int',
      doc: 'Return the number of bytes used by the stack.',
    },
    {
      name: 'heap_lock',
      kind: CK.Function,
      detail: 'micropython.heap_lock()',
      doc: 'Lock the heap.',
    },
    {
      name: 'heap_unlock',
      kind: CK.Function,
      detail: 'micropython.heap_unlock()',
      doc: 'Unlock the heap.',
    },
    {
      name: 'kbd_intr',
      kind: CK.Function,
      detail: 'micropython.kbd_intr(chr)',
      doc: 'Set the character to trigger a KeyboardInterrupt exception.',
    },
    {
      name: 'schedule',
      kind: CK.Function,
      detail: 'micropython.schedule(func, arg)',
      doc: 'Schedule func to be called "very soon".',
    },
    {
      name: 'native',
      kind: CK.Keyword,
      detail: '@micropython.native',
      doc: 'Decorator: compile the function to native machine code.',
    },
    {
      name: 'viper',
      kind: CK.Keyword,
      detail: '@micropython.viper',
      doc: 'Decorator: compile with the Viper emitter for fast execution.',
    },
  ],
  ...
  uasyncio: [
    {
      name: 'run',
      kind: CK.Function,
      detail: 'uasyncio.run(coro)',
      doc: 'Create a new event loop and run the given coroutine.',
    },
    {
      name: 'get_event_loop',
      kind: CK.Function,
      detail: 'uasyncio.get_event_loop() -> EventLoop',
      doc: 'Return the event loop for the current context.',
    },
    {
      name: 'new_event_loop',
      kind: CK.Function,
      detail: 'uasyncio.new_event_loop() -> EventLoop',
      doc: 'Return a new event loop.',
    },
    {
      name: 'sleep',
      kind: CK.Function,
      detail: 'await uasyncio.sleep(secs)',
      doc: 'Sleep for the given number of seconds.',
    },
    {
      name: 'sleep_ms',
      kind: CK.Function,
      detail: 'await uasyncio.sleep_ms(ms)',
      doc: 'Sleep for the given number of milliseconds (more efficient than sleep()).',
    },
    {
      name: 'create_task',
      kind: CK.Function,
      detail: 'uasyncio.create_task(coro) -> Task',
      doc: 'Create a task from a coroutine and schedule it to run.',
    },
    {
      name: 'gather',
      kind: CK.Function,
      detail: 'await uasyncio.gather(*coros)',
      doc: 'Run multiple coroutines concurrently.',
    },
    {
      name: 'wait_for',
      kind: CK.Function,
      detail: 'await uasyncio.wait_for(coro, timeout)',
      doc: 'Wait for coro to complete with a timeout.',
    },
    {
      name: 'wait_for_ms',
      kind: CK.Function,
      detail: 'await uasyncio.wait_for_ms(coro, timeout_ms)',
      doc: 'Wait for coro to complete with a timeout in ms.',
    },
    {
      name: 'current_task',
      kind: CK.Function,
      detail: 'uasyncio.current_task() -> Task',
    ...
    },
    {
      ...
      kind: CK.Class,
      detail: 'Task',
      doc: 'A running coroutine. Created by create_task().',
    },
    { name: 'Lock', kind: CK.Class, detail: 'Lock()', doc: 'An asynchronous mutex lock.' },
    {
      ...
      kind: CK.Class,
      detail: 'Event()',
      doc: 'An asynchronous event. Coroutines can wait for it.',
    },
    {
      name: 'Queue',
      kind: CK.Class,
      detail: 'Queue(maxsize=0)',
      doc: 'A queue for communicating between tasks.',
    },
    {
      name: 'StreamReader',
      kind: CK.Class,
      detail: 'StreamReader',
      doc: 'A stream reader for async I/O.',
    },
    {
      name: 'StreamWriter',
      kind: CK.Class,
      detail: 'StreamWriter',
      doc: 'A stream writer for async I/O.',
    },
    {
      name: 'open_connection',
      kind: CK.Function,
      detail: 'await uasyncio.open_connection(host, port)',
      doc: 'Open a TCP connection. Returns (reader, writer).',
    },
    {
      name: 'start_server',
      kind: CK.Function,
      detail: 'await uasyncio.start_server(callback, host, port)',
      doc: 'Start a TCP server.',
    },
  ],
  ...
  math: [
    {
      ...
      doc: 'The mathematical constant π.',
    },
    ...
    },
    {
      name: 'log',
      kind: CK.Function,
      detail: 'math.log(x[, base]) -> float',
      doc: 'Return the logarithm of x.',
    },
    {
      name: 'log2',
      kind: CK.Function,
      detail: 'math.log2(x) -> float',
      doc: 'Return log base 2 of x.',
    },
    {
      name: 'log10',
      kind: CK.Function,
      detail: 'math.log10(x) -> float',
      doc: 'Return log base 10 of x.',
    },
    {
      name: 'sin',
      kind: CK.Function,
    ...
    },
    {
      name: 'asin',
      kind: CK.Function,
      detail: 'math.asin(x) -> float',
      doc: 'Return the arc sine of x.',
    },
    {
      name: 'acos',
      kind: CK.Function,
      detail: 'math.acos(x) -> float',
      doc: 'Return the arc cosine of x.',
    },
    {
      name: 'atan',
      kind: CK.Function,
      detail: 'math.atan(x) -> float',
      doc: 'Return the arc tangent of x.',
    },
    {
      name: 'atan2',
      kind: CK.Function,
      detail: 'math.atan2(y, x) -> float',
      doc: 'Return atan(y / x).',
    },
    {
      name: 'ceil',
    ...
    },
    {
      name: 'trunc',
      kind: CK.Function,
      detail: 'math.trunc(x) -> int',
      doc: 'Return the truncated integer value of x.',
    },
    {
      name: 'fabs',
      kind: CK.Function,
      detail: 'math.fabs(x) -> float',
      doc: 'Return the absolute value of x as float.',
    },
    {
      name: 'fmod',
      kind: CK.Function,
      detail: 'math.fmod(x, y) -> float',
      doc: 'Return the remainder of x / y.',
    },
    {
      name: 'modf',
      kind: CK.Function,
      detail: 'math.modf(x) -> (float, float)',
      doc: 'Return fractional and integer parts of x.',
    },
    {
      name: 'frexp',
      kind: CK.Function,
      detail: 'math.frexp(x) -> (float, int)',
      doc: 'Decompose x into mantissa and exponent.',
    },
    {
      name: 'ldexp',
      kind: CK.Function,
      detail: 'math.ldexp(x, i) -> float',
      doc: 'Return x * 2**i.',
    },
    {
      name: 'isnan',
      ...
      doc: 'Return True if x is a NaN.',
    },
    {
      name: 'isinf',
      kind: CK.Function,
      detail: 'math.isinf(x) -> bool',
      doc: 'Return True if x is infinite.',
    },
    {
      name: 'isfinite',
      kind: CK.Function,
      detail: 'math.isfinite(x) -> bool',
    ...
    },
    {
      name: 'copysign',
      kind: CK.Function,
      detail: 'math.copysign(x, y) -> float',
      doc: 'Return x with the sign of y.',
    },
    {
      name: 'factorial',
      kind: CK.Function,
      detail: 'math.factorial(x) -> int',
      doc: 'Return x factorial.',
    },
    {
      name: 'gcd',
      kind: CK.Function,
  ...
  random: [
    {
      ...
      doc: 'Return a random float N such that 0.0 <= N < 1.0.',
    },
    {
      name: 'uniform',
      kind: CK.Function,
      detail: 'random.uniform(a, b) -> float',
      doc: 'Return a random float N such that a <= N <= b.',
    },
    {
      name: 'randint',
      kind: CK.Function,
    ...
    },
    {
      name: 'randrange',
      kind: CK.Function,
      detail: 'random.randrange(stop) / randrange(start, stop[, step]) -> int',
      doc: 'Return a randomly selected element from range(start, stop, step).',
    },
    {
      name: 'choice',
      kind: CK.Function,
      detail: 'random.choice(seq)',
      doc: 'Return a random element from a non-empty sequence.',
    },
    {
      name: 'shuffle',
      kind: CK.Function,
      detail: 'random.shuffle(x)',
      doc: 'Shuffle the sequence x in place.',
    },
    {
      name: 'seed',
      kind: CK.Function,
      detail: 'random.seed([n])',
      doc: 'Initialize the random number generator.',
    },
    {
      name: 'getrandbits',
      kind: CK.Function,
      detail: 'random.getrandbits(k) -> int',
  ...
  struct: [
    {
      name: 'pack',
      kind: CK.Function,
      detail: 'struct.pack(fmt, v1, v2, ...) -> bytes',
      doc: 'Pack values according to the format string.',
    },
    {
      name: 'pack_into',
      kind: CK.Function,
      detail: 'struct.pack_into(fmt, buffer, offset, v1, v2, ...)',
      doc: 'Pack values into a buffer at a given offset.',
    },
    {
      name: 'unpack',
      kind: CK.Function,
      detail: 'struct.unpack(fmt, data) -> tuple',
      doc: 'Unpack from the data according to the format string.',
    },
    {
      name: 'unpack_from',
      kind: CK.Function,
      detail: 'struct.unpack_from(fmt, data, offset=0) -> tuple',
      doc: 'Unpack from data starting at offset.',
    },
    {
      name: 'calcsize',
      kind: CK.Function,
      detail: 'struct.calcsize(fmt) -> int',
      doc: 'Return the size of the struct (number of bytes) corresponding to the format string.',
    },
  ],
  ...
  re: [
    {
      name: 'compile',
      kind: CK.Function,
      detail: 're.compile(pattern, flags=0)',
      doc: 'Compile a regular expression pattern into a regex object.',
    },
    {
      name: 'match',
      kind: CK.Function,
      detail: 're.match(pattern, string, flags=0)',
      doc: 'Try to apply the pattern at the start of the string.',
    },
    {
      name: 'search',
      kind: CK.Function,
      detail: 're.search(pattern, string, flags=0)',
      doc: 'Scan through string looking for a match.',
    },
    {
      name: 'sub',
      kind: CK.Function,
      detail: 're.sub(pattern, repl, string, count=0, flags=0)',
      doc: 'Return a string with all occurrences of pattern replaced.',
    },
    {
      name: 'split',
      kind: CK.Function,
      detail: 're.split(pattern, string, maxsplit=0, flags=0) -> list',
      doc: 'Split the string by occurrences of pattern.',
    },
    {
      name: 'findall',
      kind: CK.Function,
      detail: 're.findall(pattern, string, flags=0) -> list',
      doc: 'Return all non-overlapping matches.',
    },
    {
      name: 'DOTALL',
      kind: CK.Constant,
      detail: 're.DOTALL',
      doc: 'Make . match any char including newline.',
    },
    {
      name: 'MULTILINE',
      kind: CK.Constant,
      detail: 're.MULTILINE',
      doc: 'Multi-line matching mode.',
    },
    {
      name: 'IGNORECASE',
      kind: CK.Constant,
  ...
  socket: [
    {
      name: 'socket',
      kind: CK.Class,
      detail: 'socket.socket(af=AF_INET, type=SOCK_STREAM, proto=0)',
      doc: 'Create a new socket.',
    },
    {
      name: 'getaddrinfo',
      kind: CK.Function,
      detail: 'socket.getaddrinfo(host, port) -> list',
      doc: 'Translate the host/port argument into a sequence of 5-tuples.',
    },
    ...
    { name: 'SOCK_RAW', kind: CK.Constant, detail: 'socket.SOCK_RAW', doc: 'Raw socket type.' },
    {
      name: 'IPPROTO_TCP',
      kind: CK.Constant,
      detail: 'socket.IPPROTO_TCP',
      doc: 'TCP protocol number.',
    },
    {
      name: 'IPPROTO_UDP',
      kind: CK.Constant,
      detail: 'socket.IPPROTO_UDP',
      doc: 'UDP protocol number.',
    },
  ],
  ...
  binascii: [
    {
      name: 'hexlify',
      kind: CK.Function,
      detail: 'binascii.hexlify(data[, sep]) -> bytes',
      doc: 'Convert binary data to a hexadecimal representation.',
    },
    {
      name: 'unhexlify',
      kind: CK.Function,
      detail: 'binascii.unhexlify(data) -> bytes',
      doc: 'Convert hexadecimal data to binary.',
    },
    {
      name: 'b2a_base64',
      kind: CK.Function,
      detail: 'binascii.b2a_base64(data) -> bytes',
      doc: 'Encode data in base64.',
    },
    {
      name: 'a2b_base64',
      kind: CK.Function,
      detail: 'binascii.a2b_base64(data) -> bytes',
      doc: 'Decode base64 encoded data.',
    },
    {
      name: 'crc32',
      kind: CK.Function,
      detail: 'binascii.crc32(data[, crc]) -> int',
      doc: 'Compute CRC-32.',
    },
  ],
  ...
  hashlib: [
    {
      name: 'new',
      kind: CK.Function,
      detail: 'hashlib.new(name, data=None)',
      doc: 'Create new hash object using the algorithm name.',
    },
    {
      name: 'sha256',
      kind: CK.Function,
      detail: 'hashlib.sha256(data=None)',
      doc: 'Create SHA-256 hash object.',
    },
    {
      name: 'sha1',
      kind: CK.Function,
      detail: 'hashlib.sha1(data=None)',
      doc: 'Create SHA-1 hash object.',
    },
    {
      name: 'md5',
      kind: CK.Function,
      detail: 'hashlib.md5(data=None)',
      doc: 'Create MD5 hash object.',
    },
  ],
  ...
  io: [
    {
      name: 'BytesIO',
      kind: CK.Class,
      detail: 'io.BytesIO([initial_bytes])',
      doc: 'An in-memory stream for bytes I/O.',
    },
    {
      name: 'StringIO',
      kind: CK.Class,
      detail: 'io.StringIO([initial_value])',
      doc: 'An in-memory stream for text I/O.',
    },
    {
      name: 'FileIO',
      kind: CK.Class,
      detail: 'io.FileIO(name, mode="r")',
      doc: 'File I/O using raw bytes.',
    },
    {
      name: 'TextIOWrapper',
      kind: CK.Class,
      detail: 'io.TextIOWrapper',
      doc: 'Buffered text stream providing higher-level access to a binary stream.',
    },
  ],
  ...
  collections: [
    {
      name: 'OrderedDict',
      kind: CK.Class,
      detail: 'collections.OrderedDict([pairs])',
      doc: 'A dict subclass that remembers insertion order.',
    },
    {
      name: 'namedtuple',
      kind: CK.Function,
      detail: 'collections.namedtuple(typename, field_names)',
      doc: 'Create a tuple subclass with named fields.',
    },
    {
      name: 'deque',
      kind: CK.Class,
      detail: 'collections.deque(iterable, maxlen?)',
  ...
  requests: [
    {
      name: 'get',
      kind: CK.Function,
      detail: 'get(url, params=None, **kwargs) -> Response',
    ...
    },
    {
      name: 'post',
      kind: CK.Function,
      detail: 'post(url, data=None, json=None, **kwargs) -> Response',
    ...
    },
    {
      name: 'put',
      kind: CK.Function,
      detail: 'put(url, data=None, **kwargs) -> Response',
    ...
    },
    {
      name: 'delete',
      kind: CK.Function,
      detail: 'delete(url, **kwargs) -> Response',
    ...
    },
    {
      name: 'patch',
      kind: CK.Function,
      detail: 'patch(url, data=None, **kwargs) -> Response',
      doc: 'HTTP PATCH request.',
      returns: 'Response',
    },
    {
      name: 'head',
      kind: CK.Function,
      detail: 'head(url, **kwargs) -> Response',
    ...
    },
    {
      name: 'request',
      kind: CK.Function,
      detail: 'request(method, url, **kwargs) -> Response',
      doc: 'Generic HTTP request.',
      returns: 'Response',
    },
    {
      name: 'Session',
      kind: CK.Class,
      detail: 'Session()',
      doc: 'HTTP session with persistent settings.',
    },
...
function parsePyStubCode(code: string): StubParseResult {
  ...
  const extractDocstring = (lineIdx: number): string | undefined => {
    ...
    if (firstContent.includes(q))
      return firstContent.slice(0, firstContent.indexOf(q)).trim() || undefined;
    const parts: string[] = [firstContent.trim()];
    let k = lineIdx + 1;
    while (k < n) {
      const l = lines[k];
      if (l.includes(q)) {
        parts.push(l.slice(0, l.indexOf(q)).trim());
        break;
      }
      parts.push(l.trim());
      k++;
...
export function createPythonPlugin(provider: FileSystemProvider): IPlugin {
  ...
  return {
    manifest: {
      ...
      version: '1.0.0',
      description:
        'Python / MicroPython completions: builtins, stdlib stubs, VFS import resolution',
    ...
    activate(api) {
          ...
          'Response',
          {
            ...
            members: [
              ...
              },
              {
                ...
                kind: CK.Property,
                detail: 'ok: bool',
                doc: 'True if status_code < 400.',
              },
              {
                name: 'text',
                kind: CK.Property,
                detail: 'text: str',
                doc: 'Response body as decoded text.',
              },
              {
                name: 'content',
                kind: CK.Property,
              ...
              },
              {
                ...
                kind: CK.Property,
                detail: 'headers: dict',
                doc: 'Response headers dictionary.',
              },
              {
                name: 'url',
                kind: CK.Property,
                detail: 'url: str',
                doc: 'Final URL of the response.',
              },
              {
                name: 'encoding',
                kind: CK.Property,
                detail: 'encoding: str',
                doc: 'Encoding of the response text.',
              },
              {
                name: 'json',
                kind: CK.Method,
                detail: 'json() -> Any',
                doc: 'Deserialize response body as JSON.',
              },
              {
                name: 'raise_for_status',
                kind: CK.Method,
                detail: 'raise_for_status()',
                doc: 'Raise HTTPError if status >= 400.',
              },
              {
                name: 'iter_content',
                kind: CK.Method,
                detail: 'iter_content(chunk_size=1) -> Iterator[bytes]',
                doc: 'Iterate over response content.',
              },
              {
                name: 'close',
                kind: CK.Method,
      ...
      async function loadStubFile(vfsPath: string): Promise<void> {
        ...
        try {
          ...
          console.log(
            `[PyPlugin] stub loaded: ${vfsPath} | classes: ${result.classes.size} symbols: ${result.symbols.length}`
          );
        } catch (e) {
        ...
        if (isPy) {
          ...
          setTimeout(() => {
            ...
            const match = allModels.find(
              (m) => m.uri.toString() === uri || m.uri.toString().endsWith(uri)
            );
            if (match) {
              ...
              if (lang !== 'python') {
                console.warn(
                  `[PyPlugin] WRONG LANGUAGE! Expected 'python', got '${lang}'. Setting language...`
                );
      ...
      async function loadFileSymbols(vfsPath: string): Promise<void> {
        if (fileSymbols.has(vfsPath) || loadingPaths.has(vfsPath) || notFoundFiles.has(vfsPath))
          return;
      ...
      async function handlePythonFile(uri: string, code: string): Promise<void> {
        ...
        console.log(
          `[PyPlugin] handleFile: ${vfsPath} | symbols: ${fileSymbols.get(vfsPath)?.length ?? 0} | classes: ${classInfoCache.size}`
        );
      ...
      setTimeout(() => {
        ...
        console.log(
          `[PyPlugin] Diagnostics: total models=${allModels.length}, python models=${pyModels.length}`
        );
        ...
        if (allModels.length > 0 && pyModels.length === 0) {
          console.warn(
            '[PyPlugin] WARNING: No models have languageId="python". Completions will not fire!'
          );
      ...
      const completionDisposable = monaco.languages.registerCompletionItemProvider(
        { language: 'python' },
        {
          ...
          provideCompletionItems(model, position): monaco.languages.CompletionList {
            ...
            console.log(
              `[PyPlugin] complete | ctx=${ctx.type} | currentUri=${currentUri} | fileSymbols=${fileSymbols.size} | classes=${classInfoCache.size} | line="${lineUntilCursor}"`
            );
            ...
            if (ctx.type === 'import-module' || ctx.type === 'from-module') {
              ...
              for (const mod of ALL_MODULE_NAMES) {
                items.push({
                  ...
                  range,
                  detail:
                    MODULE_STUBS[mod].length > 0
                      ? `module (${MODULE_STUBS[mod].length} members)`
                      : 'module',
                  sortText: `1_${mod}`,
                });
              }
              ...
              if (scannedNames) {
                for (const name of scannedNames) {
                  if (
                    !ALL_MODULE_NAMES.includes(name) &&
                    name !== vfsPath.split('/').pop()?.replace(/\.py$/, '')
                  ) {
                    items.push({
                      label: name,
                      kind: CK.Module,
              ...
              for (const [cachedPath] of fileSymbols) {
                ...
                if (cachedPath.startsWith(fileDir + '/')) {
                  const rel = cachedPath
                    .slice(fileDir.length + 1)
                    .replace(/\.py$/, '')
                    .replace(/\//g, '.');
                  if (
                    rel &&
                    !ALL_MODULE_NAMES.includes(rel) &&
                    !items.find((i) => i.label === rel)
                  ) {
                    items.push({
                      label: rel,
                      kind: CK.Module,
              ...
              if (directClassInfo) {
                for (const m of directClassInfo.members) {
                  if (!items.find((it) => it.label === m.name))
                    items.push(symbolToItem(m, range, '0'));
                }
              }
            ...
            return {
              ...
              contents: [
                { value: `\`\`\`python\nimport ${name}\n\`\`\`` },
                {
                  value:
                    count > 0
                      ? `MicroPython/Python module with ${count} known members.`
                      : 'Python/MicroPython module.',
                },
              ],
            };
          }
      ...
      api.logger.info(
        'Python IntelliSense activated (MicroPython stubs + VFS symbol extraction + signature help)'
      );
