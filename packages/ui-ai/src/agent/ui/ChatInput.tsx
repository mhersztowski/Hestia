...
const AttachIcon = () => (
  <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
    <path
      d="M13.5 7.5l-6 6a4 4 0 01-5.657-5.657l6.364-6.364a2.5 2.5 0 013.536 3.535L5.379 11.38a1 1 0 01-1.415-1.414l6.364-6.364"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
    />
  ...
  return (
    <Box sx={{ borderTop: '1px solid #3c3c3c', position: 'relative' }}>
      ...
      {skillSuggestions.length > 0 && (
        ...
        >
          {skillSuggestions.map((name) => (
            ...
            >
              <Box component="span" sx={{ color: '#569cd6', fontFamily: 'monospace' }}>
                /{name}
              </Box>
              <Box component="span" sx={{ fontSize: 10, color: '#666' }}>
                skill
              </Box>
            </Box>
          ))}
                ...
                {isImage && objUrl ? (
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="#888">
                      <path
                        d="M4 1h6l4 4v9a1 1 0 01-1 1H3a1 1 0 01-1-1V2a1 1 0 011-1z"
                        stroke="#888"
                        strokeWidth="1"
                        fill="none"
                      />
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-end', gap: 0.5, p: 1 }}>
        ...
        {/* Send / Stop — while the agent is working the button becomes Stop,
            right beside the prompt rather than up in the panel's header. */}
        {processing ? (
