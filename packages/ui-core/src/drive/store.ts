...
const TEXT_EXTENSIONS = new Set([
    ...
    'ts', 'tsx', 'js', 'jsx', 'mjs', 'cjs', 'py', 'c', 'h', 'cpp', 'hpp', 'cc', 'cs', 'java', 'go',
    'rs', 'rb', 'php', 'sh', 'bash', 'zsh', 'sql', 'html', 'htm', 'css', 'scss', 'svg', 'xml',
    'csv', 'tsv', 'log', 'gitignore', 'gcode', 'ino', 'lua', 'kt', 'swift', 'gradle', 'properties',
]);
