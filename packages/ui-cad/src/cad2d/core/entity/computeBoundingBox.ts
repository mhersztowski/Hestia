...
export function computeBoundingBox(entity: Entity): BoundingBox2D {
  switch (entity.type) {
    case 'line':
      return lineBox(entity);
    case 'circle':
      return circleBox(entity);
    case 'point':
      return pointBox(entity);
    case 'polyline':
      return polylineBox(entity);
    case 'rect':
      return rectBox(entity);
    case 'arc':
      return arcBox(entity);
    case 'text':
      return textBox(entity);
    case 'image':
      return imageBox(entity);
    case 'freehand':
      return freehandBox(entity);
    case 'dimension':
      return dimensionBox(entity);
    case 'box3d':
      return box3dBox(entity);
    case 'cylinder3d':
      return cylinder3dBox(entity);
    case 'sphere3d':
      return sphere3dBox(entity);
  }
}
