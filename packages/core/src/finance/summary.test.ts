...
describe('summaries', () => {
  it('balance is the opening balance plus movements on that account', () => {
    ...
    expect(
      accountBalance(account, [t('a', '2026-01-02', -30_00), t('b', '2026-01-03', 10_00), other])
    ).toBe(80_00);
  });
  ...
  it('separates income from expenses instead of reporting the difference alone', () => {
    const s = summariseMonth(
      [t('a', '2026-01-02', -30_00), t('b', '2026-01-03', 500_00), t('c', '2026-02-01', -1_00)],
      '2026-01'
    );
  ...
  it('an empty month is zeros, not a missing result', () => {
    expect(summariseMonth([], '2026-03')).toEqual({
      month: '2026-03',
      income: 0,
      expenses: 0,
      net: 0,
